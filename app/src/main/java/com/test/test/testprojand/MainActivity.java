...
public class MainActivity extends AppCompatActivity {
    ...
    public void SetCardViewListener(){
        ...
        cardView2.setOnClickListener(view -> ThisPopularSearch("viewed"));

        cardView3.setOnClickListener(view -> ThisPopularSearch("shared"));

        cardView4.setOnClickListener(view -> ThisPopularSearch("emailed"));
    ...
    public void ThisPopularSearch(String strType) {
        AsyncTaskGetData asyncTaskGetData = new AsyncTaskGetData(MainActivity.this, (result, isSuccess) -> {
            if (isSuccess) {
                try {
                    Object object = new JSONTokener(result.toString()).nextValue();
        ...
        asyncTaskGetData.execute(setCommonHttp(GlobData.strURL+"/mostpopular/v2/"+strType+"/30.json?&api-key="+getResources().getString(R.string.api_key)), setRequestProperty());
    }
    //endregion
